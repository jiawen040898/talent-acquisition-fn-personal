import { DomainOutcome, DomainTraitOutcome, TraitOutcome } from '@pulsifi/fn';

import { JobApplicationScoreType } from '../constants';
...
export interface AssessmentRawResult {
    scores?: DomainTraitOutcome[];
}
